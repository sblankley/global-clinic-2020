...
def read(fileName):
    ...
    backend.settings.myList['stations'] = stations
    backend.settings.myList['types'] = types
    backend.settings.myList['jobs'] = jobs
    backend.settings.myList['pred'] = pred
    backend.settings.myList['numJobs'] = numJobs
    backend.settings.myList['cycleTime'] = cycleTime
    backend.settings.myList['takt'] = takt
    backend.settings.myList['cap'] = cap
    backend.settings.myList['length'] = length
    backend.settings.myList['width'] = width
    backend.settings.myList['jobNames'] = jobNames
